...
def main(args=None):
    ...
    while True:
        ...
        RRmotor_rad,RLmotor_rad,Rdown_pitch,Rup_pitch=calf("R",a,90) 
        minimal_publisher.pos=[RRmotor_rad,RLmotor_rad,Rdown_pitch,Rup_pitch] #right
        rclpy.spin_once(minimal_publisher)
