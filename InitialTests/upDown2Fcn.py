...
while True:
        ...
        # Hip Motor Control
        hipOutputAngleDesired = hipAngleOutputInitial - (90 - thetaHipIK) * np.sin(2 * np.pi * sin_counter)
        ...
        # Knee Motor Control
        kneeOutputAngleDesired = kneeAngleOutputInitial + (thetaKneeIK) * np.sin( 2 * np.pi * sin_counter)
